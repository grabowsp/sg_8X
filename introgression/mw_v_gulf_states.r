# Assign allele states to the alleles in the MW vs Gulf introgression
#  comparisons
...
#mw_freq_file <- '/home/f2p1/work/grabowsk/data/switchgrass/introgression_v3/MW_training_MWvGULF.frq'
#mw_frq <- fread(mw_freq_file)
