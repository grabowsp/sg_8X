...
### INPUT DATA ###
vcf_file <- '/home/f2p1/work/grabowsk/data/switchgrass/introgression_v3/MW_analysis/MWall_MWvATL.vcf'
...
allele_state_file <- '/home/f2p1/work/grabowsk/data/switchgrass/introgression_v3/MW_analysis/MW_v_ATL_allele_states.txt'
