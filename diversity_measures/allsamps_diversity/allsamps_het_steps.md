...
* NERSC Resulst directory
  * `/global/cscratch1/sd/grabowsp/sg_8X_scratch/diversity_analysis/allsamps_diversity/`

## Calculate homozygosity in CDS across chromosomes
### Run script
```
cd /global/cscratch1/sd/grabowsp/sg_8X_scratch/diversity_analysis/allsamps_diversity 

sbatch calc_allsamps_div.sh
```
### Example of script
```
#!/bin/bash
...
OUT_DIR=/global/cscratch1/sd/grabowsp/sg_8X_scratch/diversity_analysis/allsamps_diversity
DATA_DIR=/global/cscratch1/sd/grabowsp/sg_8X_scratch/allsamps_tet_vcfs/
DATA_FILE_SUF=.tetrasomic.CDS.allsamps.genlight.rds

OUT_PRE_SUB=allsamps.CDS
