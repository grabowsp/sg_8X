...
### LOAD INPUTS ###
pca_res_file <- '/global/cscratch1/sd/grabowsp/sg_8X_scratch/pca_analysis/geoperm_pca/GW.50kSNPs.tetrasomic.CDS.geoperm.genlight.PCAresults.rds'
...
### SET OUTPUTS ###
out_dir <- '/global/cscratch1/sd/grabowsp/sg_8X_scratch/pca_analysis/geoperm_pca/'
out_short <- 'GW.50kSNPs.geoperm.PCA.pdf'
