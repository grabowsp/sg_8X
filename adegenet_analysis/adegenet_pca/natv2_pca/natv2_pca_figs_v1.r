...
### LOAD INPUTS ###
pca_res_file <- '/global/cscratch1/sd/grabowsp/sg_8X_scratch/pca_analysis/natv2_pca/GW.50kSNPs.tetrasomic.CDS.natv2.genlight.PCAresults.rds'
...
### SET OUTPUTS ###
out_dir <- '/global/cscratch1/sd/grabowsp/sg_8X_scratch/pca_analysis/natv2_pca/'
out_short <- 'GW.50kSNPs.natv2.PCA.pdf'
